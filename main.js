...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/qZkrPxVVD/model.json',modelLoaded);
...
function gotResults(error, results){
    if(error){
        ...
        if(results[0].label == "Amazing"){
            ...
            document.getElementById("quote").innerHTML = "Oh! It Is Amazing";
        }
        if(results[0].label == "Best"){
            document.getElementById("result_emoji").innerHTML = "&#128077";
            document.getElementById("quote").innerHTML = "Thank You! It is Best";
        }
